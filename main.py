...
def editFoodDialog():
    ...
    foodLabel = tk.Label(dialog, text = "choose a food that you would like to edit")
...
def editIngredientDialog():
    def editIngrediantOnClick(ingredientName, newIngredientName):
    ...
    ingredientLabel = tk.Label(dialog, text = "choose an ingredient that you would like to edit")
    ingredientLabel.grid(column = 0, row = 0)
    ...
    newIngredientLabel = tk.Label(dialog, text = "new ingredient name")
    newIngredientLabel.grid(column = 0 , row = 1)

    inputNewIngredientName = tk.Entry(dialog)
    inputNewIngredientName.grid(column = 1, row = 1)

    tk.Button(dialog, text = "edit", command = lambda: editIngrediantOnClick(inputIngredientName.get(), inputNewIngredientName.get())).grid(column = 0 , row = 2)
    tk.Button(dialog, text = "delete", command = lambda: deleteIngredientOnClick(inputIngredientName.get())).grid(column = 1, row = 2)
...
tk.Button(window, text = "edit an existing ingredient",command = editIngredientDialog).pack()
window.mainloop()